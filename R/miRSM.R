...
## Internal function s4vd from s4vd package
## (https://github.com/cran/s4vd).
...
## Internal function updatev from s4vd package
## (https://github.com/cran/s4vd).
#update v
...
## Internal function updateu from s4vd package
## (https://github.com/cran/s4vd).
#update u
...
## Internal function updatev.pw from s4vd package
## (https://github.com/cran/s4vd).
#update v pointwise
...
## Internal function updateu.pw from s4vd package
## (https://github.com/cran/s4vd).
#update u pointwise
...
## Internal function adaLasso.nc from s4vd package
## (https://github.com/cran/s4vd).
#adaptive Lasso 
...
## Internal function adaLassoSteps.nc from s4vd package
## (https://github.com/cran/s4vd).
...
## Internal function adaLasso from s4vd package
## (https://github.com/cran/s4vd).
...
## Internal function adaLassoSteps from s4vd package
## (https://github.com/cran/s4vd).
...
## Internal function ssvd from s4vd package
## (https://github.com/cran/s4vd).
ssvd <-
...
## Internal function ssvdBC from s4vd package
## (https://github.com/cran/s4vd).
ssvdBC <- 
...
## Internal function BCs4vd and BCssvd from s4vd package
## (https://github.com/cran/s4vd).
setClass('BCs4vd',
